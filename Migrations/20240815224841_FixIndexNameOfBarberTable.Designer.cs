...
namespace Barbershop.API.Migrations
{
    ...
    [Migration("20240815224841_FixIndexNameOfBarberTable")]
    partial class FixIndexNameOfBarberTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Barbershop.API.Models.Barber", b =>
                {
                    ...
                    b.HasIndex(new[] { "Email" }, "IX_Barber_Email")
                        .IsUnique();

                    b.HasIndex(new[] { "Phone" }, "IX_Barber_Phone")
                        .IsUnique();
